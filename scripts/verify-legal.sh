...
grep -Fq 'Quantum Control Community Source Lizenz 1.0' LICENSE.de.md
grep -Fq 'Quantum Control Community Source License 1.0' LICENSE.md
...
grep -Fq 'Erlaubte Hosting- und Managed-Service-Nutzung' LICENSE.de.md
grep -Fq 'Permitted Hosting and Managed-Service Use' LICENSE.md
grep -Fq 'THIRD_PARTY_NOTICES.md' LICENSE.de.md
grep -Fq 'THIRD_PARTY_NOTICES.md' LICENSE.md

echo 'Quantum Control legal-file verification passed.'
